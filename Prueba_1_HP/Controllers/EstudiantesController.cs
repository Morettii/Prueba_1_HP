...
namespace Prueba_1_HP.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Rut,Direccion,Email,Edad,FechaNacimiento")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Rut,Direccion,Email,Edad,FechaNacimiento")] Estudiante estudiante)
        {
            if (id != estudiante.Id)
            {
                return NotFound();
